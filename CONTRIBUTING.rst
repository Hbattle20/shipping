...
Welcome to ``shipping`` contributor's guide.
...
If you experience bugs or general issues with ``shipping``, please have a look
...
You can help improve ``shipping`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``shipping`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``shipping``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n shipping python=3 six virtualenv pytest pytest-cov
    conda activate shipping
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/shipping.git
    cd shipping
...
#. Install |pre-commit|_::
   ...
   ``shipping`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/shipping
.. _issue tracker: https://github.com/<USERNAME>/shipping/issues
.. <-- end -->
